...
#
# RSpec.describe ServiceLayer::Pipeline do
#   let(:described_module) { Class.new { include ServiceLayer::Pipeline } }
#   let(:pipeline) { described_module.new(email: 'adriensldy@gmail.com') }
#
#   describe '.new' do
